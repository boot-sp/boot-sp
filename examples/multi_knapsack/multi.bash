...
echo
python -m bootsp.user_boot multi_knapsack --max-count 121 --candidate-sample-size 1 --sample-size 75 --subsample-size 10 --nB 10 --alpha 0.05 --seed-offset 100  --solver-name cplex --boot-method Bagging_with_replacement --deterministic-data-json=test.json
echo
exit
